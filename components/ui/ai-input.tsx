...
export const AIInput = ({ className, ...props }: AIInputProps) => (
  <form
    className={cn(
      'w-full divide-y overflow-hidden rounded-xl border bg-[#ffffff] shadow-sm',
      className
    )}
    {...props}
  />
...
export const AIInputTextarea = ({
  ...
  return (
    <Textarea
      ...
      ref={textareaRef}
      className={cn(
        'w-full resize-none rounded-none border-none bg-[#ffffff] px-4 pt-6 pb-3 shadow-none outline-none ring-0 focus-visible:ring-0 focus-visible:ring-offset-0',
        className
      )}
      onChange={(e) => {
        adjustHeight();
