...
import { BuilderFormFieldWrapper } from "@/components/form-builder/builder-form-field-wrapper"

import { FieldType, type FormBuilderField } from "@/types/form-builder-field"

interface RenderBuilderFieldProps {
  formField: FormBuilderField
  field: ControllerRenderProps<{ [x: string]: any }, string>
}

export function renderBuilderField({ formField, field }: RenderBuilderFieldProps) {
      ...
      return (
        <FormItem>
          ...
          <FormDescription>
            ...
            minimum value is {formField.min}, maximum value is {formField.max},
