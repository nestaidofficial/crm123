...
interface BuilderEditInputsProps {
  selectedField: FormBuilderField
}

export function BuilderEditInputs({ selectedField }: BuilderEditInputsProps) {
  const updateFormField = useFormBuilderStore(
        ...
        <>
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormField({ ...selectedField, placeholder: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormField({ ...selectedField, default: e.target.value })
              }
            />
          </div>
        </>
      ...
      return (
        <>
                ...
                <div className="flex items-end gap-2" key={idx}>
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Label"
                      value={choice.label}
                      onChange={(e) => updateChoiceItemLabel(idx, e.target.value)}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Value"
                      value={choice.value}
                      onChange={(e) => updateChoiceItemValue(idx, e.target.value)}
                    />
                  </div>
                  <Button
                    size="icon"
          ...
          <div>
            ...
            <Select
              onValueChange={(value) =>
                updateFormField({ ...selectedField, default: value })
              }
              value={selectedField.default as string}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <div className="flex h-9 items-center justify-center rounded-lg bg-muted p-1 text-muted-foreground">
              <button
                ...
                onClick={() =>
                  updateFormField({ ...selectedField, default: false })
                }
              >
                False
              </button>
              <button
                ...
                onClick={() =>
                  updateFormField({ ...selectedField, default: true })
                }
              >
                True
              </button>
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0" align="start">
                <Calendar
                  ...
                  onSelect={(date) =>
                    updateFormField({ ...selectedField, default: date })
                  }
                />
              </PopoverContent>
            </Popover>
